...
- [ ] Added E2E tests for user-facing changes
- [ ] Verified changes work offline (service worker)
- [ ] Tested on different screen sizes/browsers
...
<!-- If applicable, add screenshots or videos showing the change -->
